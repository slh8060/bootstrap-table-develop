...
(function ($) {
    ...
    var methods = {
        ...
        getSiblingsNode: function () {
            if ($(this).treegrid('getParentNodeId') === null) {
                return null;
            } else {
                return $(this).treegrid('getSetting', 'getSiblingsNodeById').apply(this, [$(this).treegrid('getParentNodeId'), $(this).treegrid('getTreeContainer')]);
            }
        },
        /**
        ...
        getCurrentNode: function () {
            return $(this).treegrid('getSetting', 'getCurrentNode').apply(this, [$(this).treegrid('getNodeId'), $(this).treegrid('getTreeContainer')]);
        },
        /**
        ...
        /**
         * Return true if checkbox isChecked
         *
         * @returns {Boolean}
         */
        isChecked: function () {
        ...
        unCheckedRecursive: function () {
            return $(this).each(function () {
                var $this = $(this);
                $this.treegrid('unchecked');
                if (!$this.treegrid('isLeaf')) {
                    $this.treegrid('getChildNodes').treegrid('unCheckedRecursive');
                }
            });
        },
        checkedRecursive: function () {
            return $(this).each(function () {
                var $this = $(this);
                $this.treegrid('checked');
                if (!$this.treegrid('isLeaf')) {
                    $this.treegrid('getChildNodes').treegrid('checkedRecursive');
                }
            });
        },
        checkedParent: function () {
            return $(this).each(function () {
                var flag = true;
                var $this = $(this);
                var siblings = $this.treegrid('getSiblingsNode');
                $(siblings).each(function () {
                    if ($(this).treegrid('isChecked') !== $this.treegrid('isChecked')) {
                        flag = false;
                        return;
                    }
                })
                if (flag) {
                    if ($this.treegrid('getParentNode') !== null) {
                        $this.treegrid('getParentNode').find('input[type="checkbox"]').prop('checked', true)
        ...
        checkedParentRecursive: function () {
            return $(this).each(function () {
                var flag = true;
                var $this = $(this);
                var siblings = $this.treegrid('getSiblingsNode');
                ...
                if (flag) {
                    if ($this.treegrid('getParentNode') !== null) {
                        $this.treegrid('getParentNode').treegrid('checked').treegrid('checkedParentRecursive');
                    }

                }
            });
        },
        unCheckedParentRecursive: function () {
            return $(this).each(function () {
                var $this = $(this);
                if ($this.treegrid('getParentNode') !== null) {
                    $this.treegrid('getParentNode').treegrid('unchecked').treegrid('unCheckedParentRecursive');
                }
            });
        },
        unCheckedParent: function () {
            return $(this).each(function () {
                var $this = $(this);
                if ($this.treegrid('getParentNode') !== null) {
                    $this.treegrid('getParentNode').find('input[type="checkbox"]').prop('checked', false)
                }
            });
        },
        /**
        ...
        render: function () {
            return $(this).each(function () {
                ...
                if ($this.treegrid('isNode')) {
                    ...
                    if (allSame) {
                        $('.th-inner').find('input[type="checkbox"]').prop('checked', $this.treegrid('isChecked'));
                    }
                }
            });
        },
        ...
        /**
         * Rendering checkbox depends on node state
         *
         * @returns {Node}
         */
        renderChildCheckbox: function () {
            return $(this).each(function () {
                var $this = $(this);
                var expander = $this.treegrid('getSetting', 'getExpander').apply(this);
                ...
                if (expander) {
                    if ($($this).find('input[type="checkbox"]').is(':checked')) {
                        $this.treegrid('checkedRecursive')
                    } else {
                        $this.find('input[type="checkbox"]').prop('checked', true);
                        $this.treegrid('unCheckedRecursive')
                    }
                } else {
                    $this.treegrid('initExpander');
                    $this.treegrid('renderExpander');
        ...
        renderParentCheckbox: function () {
            return $(this).each(function () {
                var $this = $(this);
                if ($this.treegrid('isChecked')) {
                    $this.treegrid('checkedParentRecursive')
                } else {
                    $this.treegrid('unCheckedParentRecursive')
                }
            });
        },
    ...
    $.fn.treegrid.defaults = {
        ...
        getSiblingsNodeById: function (id, treegridContainer) {
        ...
        getCurrentNode: function (id, treegridContainer) {
            var templateClass = "treegrid-" + id;
            return treegridContainer.find('tr.' + templateClass);
        },
